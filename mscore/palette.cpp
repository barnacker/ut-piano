...
static bool needsStaff(Element* e)
      ...
      switch(e->type()) {
            ...
            case Element::Type::CLEF:
            {
                ...
                return !(ct == ClefType::UTPIANO_RIGHT || ct == ClefType::UTPIANO_RIGHT_2 || ct == ClefType::UTPIANO_RIGHT_3 ||
                         ct == ClefType::UTPIANO_LEFT || ct == ClefType::UTPIANO_LEFT_2 ||ct == ClefType::UTPIANO_LEFT_3 );
...
//---------------------------------------------------------
//   needYOffset
//   Add offset to UT-Piano
//---------------------------------------------------------

static double needYOffset(Element* e)
      {
      if (e == 0)
            return 0;
      switch(e->type()) {
            case Element::Type::CLEF:
            {
                Clef* clef = static_cast<Clef*>(e);
                ClefType ct = clef->clefType();
                if (ct == ClefType::UTPIANO_RIGHT_2 ||ct == ClefType::UTPIANO_LEFT_2 )
                    return (double)-1.5;
                else if (ct == ClefType::UTPIANO_RIGHT_3 || ct == ClefType::UTPIANO_LEFT_3 )
                    return (double)1.5;
                else
                    return 0;
            }
