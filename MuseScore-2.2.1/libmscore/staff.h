...
class Staff : public QObject, public ScoreElement {
   ...
   public:
      ...
      bool isDrumStaff() const         { return staffGroup() == StaffGroup::PERCUSSION; }
 	  bool isUtPianoStaff() const      { return (staffGroup() == StaffGroup::UTPIANO_RIGHT_HAND || staffGroup() == StaffGroup::UTPIANO_LEFT_HAND);}
      bool isUtPianoRightStaff() const  { return staffGroup() == StaffGroup::UTPIANO_RIGHT_HAND;}
      bool isUtPianoLeftStaff() const   { return staffGroup() == StaffGroup::UTPIANO_LEFT_HAND;}
