...
static constexpr qreal SPATIUM20 = 5.1703;  // Pour l'espace de la porte a 1.824mm
#else
...
enum class StaffGroup : char {
      STANDARD, PERCUSSION, TAB,  UTPIANO_RIGHT_HAND, UTPIANO_LEFT_HAND
      };
const int STAFF_GROUP_MAX = int(StaffGroup::UTPIANO_LEFT_HAND) + 1;      // out of enum to avoid compiler complains about not handled switch cases
