...
void MusicXMLParserPass2::clef(const QString& partId, Measure* measure, const int tick)
      ...
      if (c == "G" && i == 0 && line == 2)
          ...
          if (line == 1) clef = ClefType::UTPIANO_RIGHT;
          else if (line == 2) clef = ClefType::UTPIANO_RIGHT_2;
          else if (line == 3) clef = ClefType::UTPIANO_RIGHT_3;
             st =StaffTypes::UTPIANO_RIGHT;
          }
     else if (c == "UTP-L") {
          if (line == 1) clef = ClefType::UTPIANO_LEFT;
          else if (line == 2) clef = ClefType::UTPIANO_LEFT_2;
          else if (line == 3) clef = ClefType::UTPIANO_LEFT_3;
            st = StaffTypes::UTPIANO_LEFT;
      }
      else
